    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t53 = text(" This application runs purely in your browser. No data is stored on this application.");
    			t54 = space();
    			div18 = element("div");
    			div5 = element("div");
    			...
    			t80 = space();
    			p11 = element("p");
    			t81 = text("Share this Twibbon on your social media: ");
    			span2 = element("span");
    			em = element("em");
    			...
    			input5.value = "1";
    			add_location(input5, file, 110, 8, 3103);
    			attr_dev(div9, "class", "left");
    			add_location(div9, file, 108, 6, 3023);
    			attr_dev(label4, "for", "divide-right-zoom");
    			add_location(label4, file, 120, 8, 3311);
    			...
    			input6.value = "1";
    			add_location(input6, file, 121, 8, 3364);
    			attr_dev(div10, "class", "right");
    			add_location(div10, file, 119, 6, 3282);
    			attr_dev(div11, "class", "form-group");
    			add_location(div11, file, 107, 4, 2991);
    			attr_dev(label5, "for", "divide-left-alpha");
    			add_location(label5, file, 133, 8, 3614);
    			...
    			input7.value = "0.5";
    			add_location(input7, file, 134, 8, 3669);
    			attr_dev(div12, "class", "left");
    			add_location(div12, file, 132, 6, 3586);
    			attr_dev(label6, "for", "divide-right-alpha");
    			add_location(label6, file, 144, 8, 3880);
    			...
    			input8.value = "0.5";
    			add_location(input8, file, 145, 8, 3936);
    			attr_dev(div13, "class", "right");
    			add_location(div13, file, 143, 6, 3851);
    			attr_dev(div14, "class", "form-group");
    			add_location(div14, file, 131, 4, 3554);
    			add_location(div15, file, 157, 8, 4194);
    			attr_dev(div16, "class", "save myth");
    			add_location(div16, file, 156, 6, 4161);
    			attr_dev(div17, "class", "form-group");
    			add_location(div17, file, 155, 4, 4129);
    			attr_dev(div18, "id", "divide");
    			set_style(div18, "display", "none");
    			add_location(div18, file, 95, 2, 2611);
    			attr_dev(div19, "id", "choose");
    			add_location(div19, file, 163, 4, 4296);
    			add_location(div20, file, 166, 8, 4398);
    			attr_dev(div21, "id", "choice-full");
    			attr_dev(div21, "class", "myth");
    			add_location(div21, file, 165, 6, 4353);
    			add_location(div22, file, 169, 8, 4481);
    			attr_dev(div23, "id", "choice-divide");
    			attr_dev(div23, "class", "myth");
    			add_location(div23, file, 168, 6, 4434);
    			attr_dev(div24, "id", "choice");
    			add_location(div24, file, 164, 4, 4328);
    			add_location(div25, file, 173, 6, 4571);
    			attr_dev(div26, "id", "return-intro");
    			attr_dev(div26, "class", "myth");
    			add_location(div26, file, 172, 4, 4527);
    			attr_dev(div27, "id", "intro");
    			set_style(div27, "display", "none");
    			add_location(div27, file, 162, 2, 4252);
    			attr_dev(p10, "class", "result");
    			add_location(p10, file, 177, 2, 4613);
    			attr_dev(em, "class", "svelte-n98e8d");
    			add_location(em, file, 178, 52, 4689);
    			add_location(span2, file, 178, 46, 4683);
    			add_location(p11, file, 178, 2, 4639);
